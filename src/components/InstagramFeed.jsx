...
const InstagramFeed = () => {
  return (
    <section className='py-16 md:py-20 lg:py-24 bg-[#fcf7e6]'>
      <div className='container mx-auto px-8'>
        ...
        >
          ...
          <h2 className='text-[60px] font-serif font-bold text-[#2c2c2c] mb-4'>
            @bruma.coffee
          </h2>
          <a
        ...
        >
          <a
            ...
            target='_blank'
            rel='noopener noreferrer'
            className='inline-block px-8 py-3 bg-[#2c2c2c] text-white font-medium text-sm tracking-widest uppercase rounded-full hover:bg-[#a67c52] transition-colors duration-300'
          >
            View More
          </a>
        </motion.div>
